class CreateOptionTypeForFrequency < ActiveRecord::Migration
  def up
    ...
    Spree::OptionValue.create!({ name: 2, presentation: 'Every 2 weeks', option_type: frequency })
    Spree::OptionValue.create!({ name: 4, presentation: 'Every 4 weeks', option_type: frequency })
  end
